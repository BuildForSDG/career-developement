  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li ><a href="#"><i class="fa fa-link"></i> <span>Trainers</span></a></li>
          ...
          <div class="tab-pane active" id="settings">
            <form class="form-horizontal">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" value="<?php echo $user['name'] ?>" name="name" id="inputName" placeholder="eg. Kofi Mensah">
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="number" class="form-control" value="<?php echo $user['mobile'] ?>" name="mobile" id="inputName" placeholder="eg.+23350000">
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" value="<?php echo $user['location'] ?>" name="location" id="inputName" placeholder="eg. Accra">
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="email" class="form-control" value="<?php echo $user['email'] ?>" name="email" id="inputEmail" placeholder="eg.nina@gmail.com">
                </div>
              </div>
              <?php 
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" value="<?php echo $user['company'] ?>" name="company"  id="inputName" placeholder="eg. Fashion Institute">
                </div>
              </div>


              <div class="form-group">
                <label for="inputName" class="col-sm-2 control-label">Educational Level</label>


                <div class="col-sm-10">
                  <select name="education_level" id="" class="form-control" >
                    <option value="">Educational Level</option>
                    <option value="SHS" <?php if($user['education_level'] == 'SHS' ) selected ?> >SHS</option>
                    <option value="Tertiary" <?php if($user['education_level'] == 'Tertiary' ) selected ?>>Tertiary</option>
              ...
              <div class="form-group">
                <label for="inputExperience" class="col-sm-2 control-label">Business Description</label>

                <div class="col-sm-10">
                  <textarea class="form-control" value="<?php echo $user['business_description'] ?>" name="business_description" id="inputExperience" placeholder=""></textarea>
                </div>
              </div>
